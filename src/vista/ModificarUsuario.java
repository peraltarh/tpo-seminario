		...
		
		{
			...
			guardarButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					boolean alta = Sistema.getInstancia().modificarUsuario(nombreTextField.getText(), apellidoTextField.getText(), Integer.parseInt(dniTextField.getText()), matricula , usuarioTextField.getText(), pswTextField.getText(), vecPermisos,borradoCheckBox.isSelected());
						if (alta){
